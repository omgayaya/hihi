...
```
https://raw.githubusercontent.com/omgayaya/multi-proxy-config-fetcher/refs/heads/main/configs/proxy_configs.txt
```
...
```
https://raw.githubusercontent.com/omgayaya/multi-proxy-config-fetcher/refs/heads/main/configs/singbox_configs.json
```
...
### Detailed Report
📊 [View Full Interactive Dashboard](https://htmlpreview.github.io/?https://github.com/omgayaya/multi-proxy-config-fetcher/blob/main/assets/performance_report.html)
